    ...
    try:
        ...
        if source == "web":
            system_prompt = (
                ...
                "6. You know Madan's full system — reminders fire via "
                "WhatsApp using Twilio (already configured), "
                "emails triage to WhatsApp, briefings go to WhatsApp. "
                "Answer questions about the system confidently and briefly.\n"
